...
# 1. Define the "DNA" of each agent in one central place
AGENT_REGISTRY = {
    "major-gift-agent": {
        "model": ".google-gemini-2.5-flash-completion",
        "system_prompt": "You are Non Profit CFO and Data scientist. Analyze these donors for 'Major Gift' capacity. Look for single large gifts and consistent high-value giving. Recommend the 'Next Best Action' for the top 3 prospects.",
    },
    "retention-risk-agent": {
        "model": ".google-gemini-2.5-flash-completion",
        "system_prompt": "You are a Donation retention specialist and data scientist. Your goal is to spot donors who are drifting away. Identify those whose giving has stopped or decreased. Suggest an immediate re-engagement strategy.",
    },
